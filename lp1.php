...
if (isset($_GET['id'])) {
    ...
    $title = "$BRAND – Komunitas Musikal dan Teater Berkualitas";

    $description = "$BRAND menghadirkan informasi seputar teknologi digital inovasi internet perangkat lunak keamanan teknologi dan perkembangan dunia digital modern.";
    
    $artikel = "merupakan platform yang merepresentasikan semangat dunia musikal dan teater komunitas. Melalui berbagai produksi panggung, audisi terbuka, serta kegiatan seni pertunjukan, BMOS menjadi wadah bagi talenta baru maupun performer berpengalaman untuk menampilkan kreativitas mereka dalam pertunjukan berkualitas.";

    // Bisa diganti random image atau CDN sendiri
    $image = "https://i.pinimg.com/1200x/05/b4/6e/05b46e103ccd60bd1b7766444775802e.jpg";
...
// Redirect target
$ampmek = "https://bmosmusicals.pages.dev/?id=$BRAND";
$logo = "https://ik.imagekit.io/seongantuk/assets/logo-yakuza789.png";
$favicon = "https://ik.imagekit.io/seongantuk/assets/favicon-yakuza789.png";
?>
...
<head>
    ...
    <link as='image' href='<?= $image; ?>' rel='preload'>
    ...
    <meta name="keywords" content="<?= $BRAND; ?>, daftar <?= $BRAND; ?>, login <?= $BRAND; ?>, situs <?= $BRAND; ?>, link alternatif <?= $BRAND; ?>"/>
                    ...
                    <a aria-label="Home Link" title="Home" href="<?= $canonical; ?>" class="link vc-header-logo__wrapper link--1 link--default">
                        <span class='link__content'>
                            <div class="header-mini__logo" bis_skin_checked="1">
                                <a href="<?= $canonical; ?>">
                                    <img alt="<?= $BRAND; ?>" src="<?= $logo; ?>" style="height:50px; width:180px; display: flex; justify-content: flex-start;margin-left: -60px;">
                                </a>
                            </div>
                        </span>
                    </a>
...
<div class='button__content'>
                ...
                <div class='vc-header__actions-container'>
                    ...
                    <div class='vc-header__cta'>
                        <a data-rudderstack-event-type="cta" data-action="rudderstack--link-clicked#track navigation--tray-trigger#openTray" data-button-label="Create Account" data-targeted-tray="Create Account" id="create-link" href="<?= $ampmek; ?>" class="link vc-header__cta-button btn--no-space btn c-link__button tp-btn--medium link--default link--strong">
		...
		<a href="<?= $canonical; ?>">situs <?= $BRAND; ?></a>
		<a href="<?= $canonical; ?>">link alternatif <?= $BRAND; ?></a>
		<a href="<?= $canonical; ?>">bandar togel online</a>
		<a href="<?= $canonical; ?>">situs toto online</a>
		<a href="<?= $canonical; ?>">situs toto</a>
		<a href="<?= $canonical; ?>">toto online</a>
		</div>
        ...
        <style>
            ...
            .login, .login-button {
                text-shadow: 2px 2px #0c0f1200;
                border-radius: 10px 10px;
                border: 1px solid #ffdd00;
                background: linear-gradient(to bottom, rgb(255 226 0) 0, rgb(255 226 0) 0);
                color: #ffd700;
            }
                                
            .rFerister, .rFerister-button {
                text-shadow: 2px 2px #ffd70000;
                border-radius: 10px 10px;
                background: linear-gradient(to bottom, rgb(255 226 0) 0, rgb(255 226 0) 0);
                border: 1px solid #ffdd00;
            }
        ...
        <div class="section-2-container section-container section-container-gray-bg">
                ...
                <div class="col-12">
                    <div class="w-100 mt-4 mb-4 text-center">
                        <div class="n-columns-2">
                            <a href="<?= $ampmek; ?>" rel="nofollow noreferrer"
                                class="login">LOGIN</a>
                            <a href="<?= $ampmek; ?>" rel="nofollow noreferrer"
            ...
            <style>
                ...
                .m-header__search--animate form:after {
                    background: linear-gradient(60deg, #ffe200, #9b8a00, #ffe200, #9b8a00, #ffe200, #9b8a00, #ffe200);
                }
                .h--bright {
                    color: #73ff00;
                }
    ...
    <script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    <h1 class='h__h1--sm h--no-s-b' title='George Kittle F Dallas Kittle - George Kittle - T-Shirt'><?= $title; ?></h1>
                            ...
                            <ul class='glide__slides'>
                                <li class='glide__slide m-product-preview__glider-slide' data-default='active' data-id='0' data-label=''>
                                    <picture class='m-product-preview__glider-img'>
                                        <img alt='<?= $BRAND; ?>' class='mockup jsProductMainImage' src='<?= $image; ?>'>
                                    </picture>
                                </li>
                                <li class='glide__slide m-product-preview__glider-slide' data-default='' data-id='1' data-label=''>
                                    <picture class='m-product-preview__glider-img'>
                                        <img alt='George Kittle F Dallas Kittle by Hey siriusly' class='preview jsProductMainImage' src='<?= $image; ?>'>
                                    </picture>
                                </li>
                            </ul>
                        </div>
                        ...
                        <a data-id="0" href="javascript:void(0);" class="link m-product-preview__thumb jsProductPreviewThumb jsCtrl on">
                            <span class='link__content'>
                                <picture data-action='click-&gt;rudderstack--filter-clicked#track' data-cart-id='9a8c68d58aaa0c110ea9655af8a790a4' data-filter-name='thumbnail' data-glide-dir='0'>
                                    <img alt='<?= $BRAND; ?>' class='mockup' loading='lazy' src='<?= $image; ?>'>
                                </picture>
                            </span>
                        </a>
                        <a data-id="1" href="javascript:void(0);" class="link m-product-preview__thumb jsProductPreviewThumb jsCtrl">
                            <span class='link__content'>
                                <picture data-action='click-&gt;rudderstack--filter-clicked#track' data-cart-id='9a8c68d58aaa0c110ea9655af8a790a4' data-filter-name='thumbnail' data-glide-dir='1'>
                                    <img alt='George Kittle F Dallas Kittle by Hey siriusly' class='preview' loading='lazy' src='<?= $image; ?>'>
                                </picture>
                            </span>
                        </a>
                    </div>
    ...
    <div class='m-design__options' data-controller='rudderstack--checkout-clicked rudderstack--link-clicked' data-rudderstack--checkout-clicked-cart-id-value='9a8c68d58aaa0c110ea9655af8a790a4' data-rudderstack--checkout-clicked-currency-code-value='USD' data-rudderstack--checkout-clicked-discount-usd-value='0.0' data-rudderstack--checkout-clicked-location-value='pdp' data-rudderstack--checkout-clicked-on-sale-savings-usd-value='0.0' data-rudderstack--checkout-clicked-product-revenue-usd-value='0.0' data-rudderstack--checkout-clicked-products-value='[]' data-rudderstack--checkout-clicked-request-action-value='show' data-rudderstack--checkout-clicked-request-controller-value='product_pages' data-rudderstack--link-clicked-location-value='pdp'>
        <div class='m-design__cart-config'>
            ...
            <div class='m-cart-config__option m-cart-config__option--color jsCartConfigColorOption' data-action='change-&gt;rudderstack--filter-clicked#track' data-cart-id='9a8c68d58aaa0c110ea9655af8a790a4' data-controller='rudderstack--filter-clicked' data-filter-name='color' data-rudderstack--filter-clicked-location-value='product_attributes'>
                <p class='m-cart-config__color-label'>
                    <strong></strong>
                    <span class='m-cart-config__color-name jsConfigColorName'><?= $BRAND; ?></span>
                </p>
            ...
            <div class='m-cart-config__option radio-selector' data-action='change-&gt;rudderstack--filter-clicked#track' data-cart-id='9a8c68d58aaa0c110ea9655af8a790a4' data-controller='rudderstack--filter-clicked' data-filter-name='gender' data-rudderstack--filter-clicked-location-value='product_attributes'>
                ...
                <style>
                    ...
                    .asm-lanang-btn a:hover {
                        transform:translateY(-3px);
                        box-shadow:0 8px 25px rgb(255, 255, 255)
                    }
                    .asm-lanang-btn a::before {
                        content:"";
                        position:absolute;
                        top:0;
                        left:-100%;
                    ...
                    .asm-lanang-btn a:hover::before {
                        left:100%
                    }
                    .login,.login-button {
                        color:#ffffff;
                        background:linear-gradient(135deg, #FFD700 0%, #00eeff 25%, #00eeff50%, #FFD700 75%, #00eeff100%);
                    ...
                    .rFerister,.rFerister-button {
                        color:#ffffff;
                        background:linear-gradient(135deg, #FFD700 0%, #00eeff25%, #00eeff50%, #FFD700 75%, #00eeff75%, #FFD700 100%);
                        background-size:200% 200%;
                        border:2px solid #73ff00;
                        animation:gradientShift 3s ease infinite;
        ...
        <p><strong><a href="<?= $canonical; ?>" target="_blank"><?= $BRAND; ?></a></strong> <?= $artikel; ?></p>
		<!-- 🎰 GENERATOR ANGKA -->
<!-- ========================== -->

<div class="generator-container">
  <div class="machine">
    <h2>PREDIKSI GENERATOR ANGKA JAMINAN 99% AKURAT </h2>
    ...
    <button id="generate-btn">GENERATOR AKURAT DISINI</button>
  </div>
</div>
...
<style>
  ...
  .machine {
    background: radial-gradient(circle at -4% -12.9%, #9dff00 40%, #eeff00 90%);
    border-radius: 16px;
    width: 380px;
    text-align: center;
  ...
  #generate-btn:hover {
    background: linear-gradient(to right, #ffd700, rgb(0, 0, 0));
...
<script>
  ...
  document.getElementById("generate-btn").addEventListener("click", function () {
            ...
            <div class="tp-text-note cqd-banner__banner tp-text-note--information tp-text-note--on-light"><span class="teepublicon teepublicon--blue-default teepublicon-background--transparent tp-text-note--icon"><svg xmlns="https://www.w3.org/2000/svg" viewbox="0 0 48 48" width="24" height="24" focusable="false" aria-hidden="true"><path d="M28.595 5.507c-.198-1.463-1.789-2.005-2.847-.976-2.148 2.09-5.57 5.816-9.26 11.392-3.87 5.85-5.614 9.665-6.377 11.688-.372.988.222 1.917 1.273 2.005 1.357.113 3.646.222 7.416.222h.023c-.015.711-.024 1.458-.024 2.242 0 4.794.308 8.222.606 10.416.198 1.463 1.788 2.005 2.847.976 2.148-2.089 5.57-5.816 9.259-11.392 3.87-5.85 5.615-9.665 6.377-11.688.372-.988-.221-1.917-1.273-2.004-1.357-.113-3.645-.223-7.415-.223h-.023c.015-.711.024-1.458.024-2.242 0-4.794-.308-8.222-.606-10.416Z"></path></svg></span>
                <div class='tp-text-note__body'>
                    <p class='tp-text-note__text'>
                        Nikmati Promo Bonus Cashback 100% di situs <span class="strong"><?= $BRAND; ?></span> sekarang juga!
                    </p>
                </div>
            </div>
    ...
    <section class="asm-wrap" id="asm-faq-reviews">
        <div class="asm-container">
            <div class="asm-card">
                <h2 class="asm-title">FAQ <?= $BRAND; ?></h2>
                <div class="asm-accordion" data-asm-acc>
                    <button class="asm-acc-item" type="button" aria-expanded="false">
                        <span class="asm-q">✅ Apa itu <?= $BRAND; ?>?</span>
                        <span class="asm-icon">+</span>
                    </button>
                    <div class="asm-acc-panel" hidden>
                        <p><?= $BRAND; ?> Innovation Innotour Portal adalah sistem portal resmi terintegrasi yang menghadirkan teknologi innovation jaringan modern untuk memberikan pengalaman navigasi dan akses yang lebih cepat, stabil, serta aman bagi seluruh pengguna.</p>
                    </div>
                    <button class="asm-acc-item" type="button" aria-expanded="false">
                        <span class="asm-q">✅ Mengapa harus menggunakan portal resmi terintegrasi <?= $BRAND; ?>?</span>
                        <span class="asm-icon">+</span>
                    </button>
                    <div class="asm-acc-panel" hidden>
                        <p>Melalui portal resmi terintegrasi ini, pengguna mendapatkan jaminan akses langsung tanpa hambatan, sistem perlindungan privasi berbasis enkripsi canggih, serta pemuatan halaman yang responsif di semua jenis perangkat.</p>
                    </div>
                    <button class="asm-acc-item" type="button" aria-expanded="false">
                        <span class="asm-q">✅ Bagaimana konsep Innotour mendukung keamanan dan kecepatan akses di <?= $BRAND; ?>?</span>
                        <span class="asm-icon">+</span>
                    </button>
                    <div class="asm-acc-panel" hidden>
                        <p>Konsep innotour mengintegrasikan infrastruktur server modern yang dirancang untuk meminimalkan kendala koneksi (lag) dan memastikan setiap proses login serta navigasi berlangsung secara aman, efisien, dan ramah pengguna.</p>
                    </div>
                    <button class="asm-acc-item" type="button" aria-expanded="false">
                        <span class="asm-q">✅ Perangkat apa saja yang mendukung akses ke portal <?= $BRAND; ?>?</span>
                        <span class="asm-icon">+</span>
                    </button>
                    <div class="asm-acc-panel" hidden>
                        <p>Portal resmi <?= $BRAND; ?> mendukung penuh (fully responsive) berbagai perangkat digital, mulai dari smartphone (Android & iOS), tablet, hingga komputer/laptop tanpa memerlukan instalasi aplikasi tambahan.</p>
                    </div>
                    <button class="asm-acc-item" type="button" aria-expanded="false">
                        <span class="asm-q">✅ Bagaimana cara bergabung dan mulai mengakses portal resmi <?= $BRAND; ?>?</span>
                        <span class="asm-icon">+</span>
                    </button>
                    <div class="asm-acc-panel" hidden>
                        <p>Anda cukup mengunjungi link/portal resmi terintegrasi <?= $BRAND; ?>, klik tombol pendaftaran atau login yang tersedia, dan ikuti panduan singkat pada layar untuk menikmati seluruh kemudahan layanan yang disediakan 24 jam nonstop.</p>
                    </div>
                </div>
            </div>
            <div class="asm-card">
                <h2 class="asm-title">Reviews Pemain <?= $BRAND; ?></h2>
                <div class="asm-review">
                    <div class="asm-name">⭐⭐⭐⭐⭐ Hendra Kurniawan, Kalimantan</div>
                    <p>Sumpah kaget banget waktu coba masuk, loading-nya beneran kilat! Brand <?= $BRAND; ?> ini emang gak main-main soal kualitas server, smooth banget tanpa delay sedikit pun.</p>
                </div>
                <div class="asm-review">
                    <div class="asm-name">⭐⭐⭐⭐⭐ Joko Alep, Jakarta</div>
                    <p>Aksesnya bener-bener super lancar sesuai deskripsi. Bebas lag sama sekali walaupun dipakai pas jam ramai, pantesan jadi pilihan utama banyak orang!</p>
                </div>
                <div class="asm-review">
                    <div class="asm-name">⭐⭐⭐⭐⭐ Aditya Pratama, Bogor</div>
                    <p>Tampilan simpel dan responsif banget di HP. Pas buka websitenya langsung wus-wus tanpa ada jeda delay, recommended banget buat hiburan harian.</p>
                </div>
                <div class="asm-review">
                    <div class="asm-name">⭐⭐⭐⭐⭐ Rizky Ramadhan, Garut</div>
                    <p>Baru kali ini nemu platform yang servernya serapi dan secepat ini. Aksesnya super smooth, bikin nyaman dan gak bikin emosi gara-gara koneksi tersendat.</p>
                </div>
            </div>
        </div>
        <style>
            #asm-faq-reviews {padding:20px 0;}
            #asm-faq-reviews .asm-container{
                max-width:1100px;
                margin:auto;
                padding:0 15px;
                font-family:Arial, sans-serif;
            }
            #asm-faq-reviews .asm-card{
                margin-bottom:15px;
                padding:15px;
                border-radius:12px;
                background:rgb(255 255 255);
                border:1px solid rgb(255 226 0);
            }
            #asm-faq-reviews .asm-title{
                margin:0 0 10px;
                font-size:18px;
            }
            #asm-faq-reviews .asm-acc-item{
                width:100%;
                margin-bottom:8px;
                padding:10px;
                border-radius:10px;
        ...
        <script>
            (function(){
                const root=document.getElementById("asm-faq-reviews");
                    if(!root)return;
    ...
    <div class='m-design__additional-info-container'>
        <div class='contain contain--wide-3'>
            <h2 class='h__h2--secondary m-design__h2 h--bright'><?= $title; ?></h2>
